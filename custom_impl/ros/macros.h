...
#define ROS_DEBUG_NAMED(X, ...) if(true) { printf(X); printf(__VA_ARGS__); printf("\n"); }
...
#define ROS_DEBUG(...)  if(true) {printf( __VA_ARGS__); printf("\n");}
...
#define ROS_DEBUG_STREAM(...) if(true) { std::cerr <<  __VA_ARGS__ << std::endl;}
#define ROS_ERROR_STREAM(...) if(true) { std::cerr <<  __VA_ARGS__ << std::endl;}
#define ROS_WARN_STREAM(...) if(true) { std::cerr <<  __VA_ARGS__ << std::endl;}
#define ROS_INFO_STREAM(...) if(true) { std::cerr <<  __VA_ARGS__ << std::endl;}
